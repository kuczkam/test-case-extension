testCaseRun = () => {
    ...
    const css = ".tc-container{position:fixed;left:-382px;top:10%;width:382px;min-height:300px;background:#ff4954;z-index:100;transition:1s;border-radius:0 0 2% 0; }.tc-container:hover{left:0;transition:1s;}.tc-list{list-style-type:none;padding-left:10px;margin:0;}.tc-list > li{color:#fff;padding:5px;font-size:14px;display:block;}.tc-list > li > p{margin:0;}.tc-icon{position:absolute;width:40px;height:40px;right:-37px;}.tc-btn{border-radius:20px;border:2px solid;background:#3a2996;padding:5px;width:70px;margin:7px 5px 5px 5px;color:#fff;}.tc-btn:hover{background:#fff;color:#ff4954;border:2px solid;}.tc-scroll::-webkit-scrollbar{width:0;}.tc-scroll::-webkit-scrollbar-track{background: transparent;}.tc-scroll{overflow:scroll;height:300px;width:370px;padding-top:15px;}#div_id{width:200px;height:200px;}#tc-copy{margin-left:16px;margin-top:16px}";
    ...
    const createStepElement = (e, value) => {  
    ...
    document.addEventListener("click", (e) => {
        createStepElement(e, e.target.outerHTML);
