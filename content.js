testCaseRun = () => {
    ...
    const testCaseContainer = _createElem("div", {class:"tc-container"});
    const ul = _createElem("ul", {class:"tc-list"});
    const copyBtn = _createElem("BUTTON", {class:"tc-btn", id: "tc-copy"});
    const clearBtn = _createElem("BUTTON", {class:"tc-btn", id: "tc-clear"});
    const iconDiv = _createElem("div", {class:"tc-icon"});
    const itemDiv = _createElem("div", {class:"tc-scroll"});
    ...
    const _copyTestCase = () => {
        ...
        const area = _createElem("textarea", {id: "tc-area_id"})
    ...
    const _createStepElement = (e, value) => {  
        ...
        if (e.target.id != "tc-pass" && e.target.id != "tc-fail" && e.target.id != "tc-copy") {          
            ...
            const pass = _createElem("BUTTON", {class:"tc-btn", id: "tc-pass", "data-testcase":""});
            const fail = _createElem("BUTTON", {class:"tc-btn", id: "tc-fail"});
    ...
    document.addEventListener("keyup", (e) => {
        if (e.target.type == "text" && e.key == "Tab") {
            setTimeout(() => {
                _createStepElement(e, e.target.outerHTML);
            }, 3000)
        }
